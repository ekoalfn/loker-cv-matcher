<x-layout
    title="Mock Interview Testing - Login"
        ...
        <div class="w-full max-w-sm animate-fade-up">
            <div class="text-center mb-8">
                <div class="w-16 h-16 rounded-2xl mx-auto mb-4 flex items-center justify-center"
                     style="background: linear-gradient(135deg, #059669, #14b8a6); box-shadow: 0 4px 20px rgba(5, 150, 105, 0.25);">
                ...
                <p class="text-sm text-stone-500 mt-1.5">Masukkan password untuk membuka halaman testing</p>
            </div>

            <form action="{{ route('mock-interview.authenticate') }}" method="POST"
                  class="surface rounded-2xl p-6 space-y-5">
                @csrf

                <div>
                    <label for="mock-interview-password" class="block text-sm font-medium text-stone-600 mb-1.5">Password</label>
                    <input
                        type="password"
                        id="mock-interview-password"
                        name="password"
            ...
            <p class="text-center text-xs text-stone-400 mt-4">
                Halaman ini hanya untuk pengujian internal.
            </p>
        </div>
    </div>
